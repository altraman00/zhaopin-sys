 ...
 */
@Entity
@Table(name = "sys_degree_salary_copy1", schema = "db_feo_zhaopin", catalog = "")
public class SysDegreeSalaryCopy1Entity {
    private String id;
    ...
    public boolean equals(Object o) {
        ...
        SysDegreeSalaryCopy1Entity that = (SysDegreeSalaryCopy1Entity) o;
